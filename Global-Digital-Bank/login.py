...
def start():
    ...
    if choice == 1:
        ...
        while True:
            ...
            print("9. Export Accounts to File")
            print("10. Average Balance Calculator")
            print("11. Count Active Accounts")
            print("12. Delete All Accounts")
            print("13. System Exit with Autosave")
            print("14. Import Accounts from File")
            print("15. Exit")
